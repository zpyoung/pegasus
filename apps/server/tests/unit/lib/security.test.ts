...
describe('security.ts', () => {
  ...
  describe('initAllowedPaths', () => {
    it('should load ALLOWED_ROOT_DIRECTORY if set', async () => {
      ...
      const { initAllowedPaths, getAllowedPaths } = await import('@pegasus/platform');
      initAllowedPaths();
  ...
  describe('isPathAllowed', () => {
    it('should allow paths within ALLOWED_ROOT_DIRECTORY', async () => {
      ...
      const { initAllowedPaths, isPathAllowed } = await import('@pegasus/platform');
      initAllowedPaths();
  ...
  describe('validatePath', () => {
    it('should return resolved path for allowed paths', async () => {
      ...
      const { initAllowedPaths, validatePath } = await import('@pegasus/platform');
      initAllowedPaths();
