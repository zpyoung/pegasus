...
describe("IdeationService", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(platform.getIdeasDir).mockReturnValue(
      "/test/project/.pegasus/ideation/ideas",
    );
  ...
  describe("Session Management", () => {
    describe("startSession", () => {
      it("should create a new session with default options", async () => {
        ...
        expect(platform.ensureIdeationDir).toHaveBeenCalledWith(
          testProjectPath,
        );
    ...
    describe("stopSession", () => {
      ...
      it("should handle stopping non-existent session gracefully", async () => {
        await expect(
          service.stopSession("non-existent"),
  ...
  describe("Ideas CRUD", () => {
    ...
    describe("updateIdea", () => {
      it("should update idea fields", async () => {
        ...
        const updated = await service.updateIdea(
          testProjectPath,
          "idea-123",
          updates,
        );
    ...
    describe("deleteIdea", () => {
      ...
      it("should handle non-existent idea gracefully", async () => {
        ...
        await expect(
          service.deleteIdea(testProjectPath, "non-existent"),
        ).resolves.not.toThrow();
      });
    });
  ...
  describe("Idea to Feature Conversion", () => {
    describe("convertToFeature", () => {
      it("should convert idea to feature with basic fields", async () => {
        ...
        const feature = await service.convertToFeature(
          testProjectPath,
          "idea-123",
        );
      ...
      it("should throw error for non-existent idea", async () => {
        ...
        await expect(
          service.convertToFeature(testProjectPath, "non-existent"),
        ).rejects.toThrow("Idea non-existent not found");
      });
    });
  });
  ...
  describe("Prompt Management", () => {
    ...
    describe("getPromptsByCategory", () => {
      ...
      it("should return empty array for non-existent category", () => {
        const filtered = service.getPromptsByCategory(
          "non-existent-category" as any,
        );
  ...
  describe("Suggestion Generation", () => {
    describe("generateSuggestions", () => {
      ...
      it("should include app spec context when useAppSpec is enabled", async () => {
        ...
        vi.mocked(platform.getAppSpecPath).mockReturnValue(
          "/test/project/.pegasus/app_spec.txt",
        );
        ...
        expect(chatOptionsCall.systemPrompt).toContain(
      ...
      it("should exclude app spec context when useAppSpec is disabled", async () => {
        ...
        expect(chatOptionsCall.systemPrompt).not.toContain(
