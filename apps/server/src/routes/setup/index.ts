...
import { createClaudeCliStatusHandler } from "./routes/claude-cli-status.js";
...
export function createSetupRoutes(): Router {
  ...
  router.get("/claude-cli-status", createClaudeCliStatusHandler());
  ...
  router.post(
    "/cursor-permissions/profile",
    createApplyPermissionProfileHandler(),
  );
  router.post(
    "/cursor-permissions/custom",
    createSetCustomPermissionsHandler(),
  );
