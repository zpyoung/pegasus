...
import {
  ...
  createPromptsByCategoryHandler,
...
export function createIdeationRoutes(
  ...
  router.post(
    "/session/stop",
    createSessionStopHandler(events, ideationService),
  );
  router.post(
    "/session/get",
    validatePathParams("projectPath"),
  ...
  router.post(
    "/analyze",
    validatePathParams("projectPath"),
    createAnalyzeHandler(ideationService),
  );
  router.post(
    "/analysis",
    validatePathParams("projectPath"),
  ...
  router.get(
    "/prompts/:category",
    createPromptsByCategoryHandler(ideationService),
  );
