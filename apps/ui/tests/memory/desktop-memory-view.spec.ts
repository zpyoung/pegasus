...
test.describe("Desktop Memory View", () => {
  ...
  test("shows file list and editor side-by-side with desktop toolbar", async ({
    page,
  }) => {
    ...
    await expect(
      page.locator('[data-testid="create-memory-button"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="refresh-memory-button"]'),
    ).toBeVisible();
    ...
    await expect(
      page.locator('[data-testid="memory-file-list"]'),
    ).toBeVisible();
    await expect(
      page.locator(
    ...
    await expect(
      page.locator('[data-testid="delete-memory-file"]'),
    ).toBeVisible();
