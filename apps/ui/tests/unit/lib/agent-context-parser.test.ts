  ...
  describe("formatModelName", () => {
    describe("Provider-aware lookup", () => {
      it("should return provider displayName when providerId matches and model is found", () => {
        ...
        expect(formatModelName("claude-sonnet-4-5", options)).toBe(
          "Moonshot v1.8",
        );
        expect(formatModelName("claude-opus-4-6", options)).toBe(
          "Moonshot v1.8 Pro",
        );
      });
        ...
        const providers: ClaudeCompatibleProvider[] = [
          {
            ...
            models: [
              ...
              {
                id: "claude-opus-4-6",
                displayName: "Claude Opus (OpenRouter)",
              },
    ...
    describe("Codex/GPT model formatting", () => {
      ...
      it("should format codex-gpt-5.1-codex-mini as GPT-5.1 Mini", () => {
        expect(formatModelName("codex-gpt-5.1-codex-mini")).toBe(
          "GPT-5.1 Mini",
        );
      });
