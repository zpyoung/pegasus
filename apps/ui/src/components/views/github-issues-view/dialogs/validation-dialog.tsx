      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        {validationResult ? (
          <div className="space-y-6 py-4">
              ...
              {validationResult.estimatedComplexity && (
                <div className="text-right">
                  ...
                  <p
                    className={cn(
                      "text-sm font-medium",
                      complexityConfig[validationResult.estimatedComplexity]
                        .color,
                    )}
                  >
                    {
            ...
            {validationResult.prAnalysis &&
              validationResult.prAnalysis.hasOpenPR && (
                <div
                  className={cn(
                    "p-3 rounded-lg border",
                    validationResult.prAnalysis.recommendation ===
                      "wait_for_merge"
            ...
            {!validationResult.prAnalysis?.hasOpenPR &&
              issue.linkedPRs?.some(
                (pr) => pr.state === "open" || pr.state === "OPEN",
              ) && (
            ...
            {/* Related Files */}
            {validationResult.relatedFiles &&
              validationResult.relatedFiles.length > 0 && (
                <div className="space-y-2">
                  <h4 className="text-sm font-medium flex items-center gap-2">
            ...
            {validationResult.missingInfo &&
              validationResult.missingInfo.length > 0 && (
                <div className="space-y-2">
                  <h4 className="text-sm font-medium flex items-center gap-2">
