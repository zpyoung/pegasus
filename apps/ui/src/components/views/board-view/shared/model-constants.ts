 ...
 */
export const CURSOR_MODELS: ModelOption[] = Object.entries(
  CURSOR_MODEL_MAP,
).map(([id, config]) => ({
...
export const CODEX_MODELS: ModelOption[] = [
  {
    ...
    label: "GPT-5.2-Codex",
    description:
      "Most advanced agentic coding model for complex software engineering.",
    badge: "Premium",
    provider: "codex",
    hasThinking: true,
  },
 ...
 */
export const OPENCODE_MODELS: ModelOption[] = OPENCODE_MODEL_CONFIGS.map(
  (config) => ({
    id: config.id,
    label: config.label,
    description: config.description,
 ...
 */
export const GEMINI_MODELS: ModelOption[] = Object.entries(
  GEMINI_MODEL_MAP,
).map(([id, config]) => ({
 ...
 */
export const COPILOT_MODELS: ModelOption[] = Object.entries(
  COPILOT_MODEL_MAP,
).map(([id, config]) => ({
