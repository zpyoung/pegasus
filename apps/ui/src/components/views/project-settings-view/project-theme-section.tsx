...
export function ProjectThemeSection({ project }: ProjectThemeSectionProps) {
  ...
  useEffect(() => {
    ...
    const currentIsLight = lightThemes.some(
      (t) => t.value === (project.theme || globalTheme),
    );
        ...
        <div className="group flex items-start space-x-3 p-3 rounded-xl hover:bg-accent/30 transition-colors duration-200 -mx-3">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground/80 leading-relaxed">
              When enabled, this project will use the global theme setting.
              Disable to set a project-specific theme.
            </p>
          </div>
        </div>
