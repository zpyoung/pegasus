  ...
  const sections: WikiSection[] = [
    {
      ...
      content: (
        <div className="space-y-3">
          <p>
            <strong className="text-foreground">Pegasus</strong> is an autonomous AI development
            studio that helps developers build software faster using AI agents.
          </p>
          <p>
            At its core, Pegasus provides a visual Kanban board to manage features. When you're
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Pegasus is built as a monorepo with two main applications and shared libraries:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>Here's what happens when you use Pegasus to implement a feature:</p>
      ...
      content: (
        <div className="space-y-3">
          <p>
            ...
            <code className="px-1 py-0.5 bg-muted rounded text-xs">.pegasus/</code> directory:
          </p>
          <div className="grid gap-2 mt-4">
            {[
              {
