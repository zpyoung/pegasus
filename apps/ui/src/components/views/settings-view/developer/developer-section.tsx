...
const LOG_LEVEL_OPTIONS: {
  ...
  { value: "warn", label: "Warning", description: "Show warnings and errors" },
  {
    value: "info",
    label: "Info",
    description: "Show general information (default)",
  },
  {
    value: "debug",
    label: "Debug",
    description: "Show all messages including debug",
  },
];
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            Control the verbosity of API server logs. Set to "Error" to only see
        ...
        {IS_DEV && (
          <div className="flex items-center justify-between pt-4 border-t border-border/30">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Show React Query DevTools panel in the bottom-right corner for
                debugging queries and cache.
              </p>
            </div>
            <Switch
              ...
              onCheckedChange={(checked) => {
                ...
                toast.success(
                  checked
                    ? "Query DevTools enabled"
                    : "Query DevTools disabled",
                  {
