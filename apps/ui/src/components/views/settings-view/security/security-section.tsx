    ...
    >
      ...
      <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3.5 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-muted-foreground/70 mt-0.5">
                Display a security warning when not running in a sandboxed
                environment
              </p>
            </div>
          </div>
        ...
        <p className="text-xs text-muted-foreground/60 px-4">
          When enabled, you&apos;ll see a warning on app startup if you&apos;re
          not running in a containerized environment (like Docker). This helps
          remind you to use proper isolation when running AI agents.
        </p>
      </div>
    </div>
  );
