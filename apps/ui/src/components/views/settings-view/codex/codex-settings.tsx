...
const WEB_SEARCH_DESCRIPTION =
  "Allow Codex to search the web for current information.";
      ...
      <div className="p-6 space-y-5">
        <div className="group flex items-start space-x-3 p-3 rounded-xl hover:bg-accent/30 transition-colors duration-200 -mx-3">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onAutoLoadCodexAgentsChange(checked === true)
            }
            className="mt-1"
        ...
        <div className="group flex items-start space-x-3 p-3 rounded-xl hover:bg-accent/30 transition-colors duration-200 -mx-3">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onCodexEnableWebSearchChange(checked === true)
            }
            className="mt-1"
        ...
        <div className="group flex items-start space-x-3 p-3 rounded-xl hover:bg-accent/30 transition-colors duration-200 -mx-3">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              onCodexEnableImagesChange(checked === true)
            }
            className="mt-1"
