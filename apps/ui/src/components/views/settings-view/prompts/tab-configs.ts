...
export const TAB_CONFIGS: TabConfig[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description:
          "Comprehensive Software Design Document with phased implementation",
    ...
    fields: [
      {
        ...
        label: "System Prompt",
        description:
          "Defines the AI's role and behavior in interactive chat sessions",
    ...
    fields: [
      {
        ...
        description:
          "System prompt for generating project specifications from overview",
      ...
      },
      {
        ...
        description:
          "Prompt for generating features from a project specification",
    ...
    fields: [
      {
        ...
        description:
          "Prompt for generating descriptions of text files added as context",
      ...
      },
      {
        ...
        description:
          "Prompt for generating descriptions of images added as context",
    ...
    fields: [
      {
        ...
        description:
          "Prompt for analyzing the project and suggesting new features",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description:
          "Instructions for automated Playwright verification (when enabled)",
        defaultValue:
      ...
      },
      {
        ...
        description:
          "System prompt for extracting learnings/ADRs from implementation output",
        defaultValue:
