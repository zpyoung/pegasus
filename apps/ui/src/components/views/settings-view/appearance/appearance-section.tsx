...
export function AppearanceSection({
  ...
  const fontSansValue =
    fontFamilySans && isValidSansFont(fontFamilySans)
      ? fontFamilySans
      : DEFAULT_FONT_VALUE;
  const fontMonoValue =
    fontFamilyMono && isValidMonoFont(fontFamilyMono)
      ? fontFamilyMono
      : DEFAULT_FONT_VALUE;
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4 pt-6 border-t border-border/50">
          ...
          <p className="text-xs text-muted-foreground -mt-2 mb-4">
            Set default fonts for all projects. Individual projects can override
            these settings.
          </p>
        ...
        <div className="space-y-4 pt-6 border-t border-border/50">
          ...
          <p className="text-xs text-muted-foreground -mt-2 mb-4">
            Choose between a modern unified sidebar or classic Discord-style
            layout with a separate project switcher.
          </p>
        ...
        <div className="space-y-4 pt-6 border-t border-border/50">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-1 flex-1">
              <Label
                htmlFor="default-sort-newest-card-on-top"
                className="text-sm"
              >
                Sort Newest First
              </Label>
              <p className="text-xs text-muted-foreground">
                Sort all cards by creation date (newest on top) across all board
                columns and list view.
              </p>
            </div>
            <Switch
