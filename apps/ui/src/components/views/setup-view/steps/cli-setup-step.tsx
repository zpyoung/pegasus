...
interface CliSetupConfig {
  ...
  buildCliAuthStatus: (
    previous: CliSetupAuthStatus | null,
  ) => CliSetupAuthStatus;
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            copyCommand(config.installCommands.macos)
                          }
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            copyCommand(config.installCommands.windows)
                          }
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                        ...
                        const getHelpfulSuggestion = () => {
                          ...
                          if (isUsageLimitIssue) {
                            return {
                              ...
                              action:
                                "Wait a few minutes and try again, or check your billing",
                            };
                          }
                          ...
                          if (
                            ...
                            return {
                              ...
                              message:
                                "Your OAuth token needs to be refreshed.",
                          ...
                          if (
                            ...
                            return {
                              ...
                              message:
                                "You need to authenticate with your account.",
            ...
            <AccordionItem value="api-key" className="border-border">
              ...
              <AccordionContent className="pt-4 space-y-4">
                <div className="space-y-4 p-4 rounded-lg bg-muted/30 border border-border">
                  <div className="space-y-2">
                    <Label
                      htmlFor={config.testIds.apiKeyInput}
